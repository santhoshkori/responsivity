...
class App extends Component {
  ...
  myfilteredlist = () => {
    ...
    const myfilteredlistds = projectsList.filter(
      eachfilter => eachfilter.category === activetabid,
    )
    return myfilteredlistds
  }

  render() {
    const {activetabid} = this.state
    const mycategoryprojects = this.myfilteredlist()
    ...
    return (
      <div className="app-container">
        ...
        <ul className="project-list-container">
          {mycategoryprojects.map(projectDetails => (
            <ProjectItem
